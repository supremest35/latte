               ...
               <table class="table" style="border-width:10px; font-size: small;">
                   ...
                   <tbody>
                       ...
                       <tr>
                           ...
                           <c:if test="${category.no == 100 && not empty board.imageFilename }">
                           ...
                           <td>
                           	<a href="detail.do?boardNo=${board.no }&catno=${board.categoryNo}" class="href">
                           	...
                           	<%-- <c:if test="${category.no = 100 }"> --%>
                           	<p style="font-size: 12px;"><a href="index.do?catno=${board.categoryNo}">${board.categoryName }</a></p>
                           	<%-- </c:if> --%>
	       ...
	       <div class="col-12">
		       <ul class="pagination justify-content-center">
			       <li class="page-item ${page.pageNo gt 1 ? '' : 'disabled' }"> 
				       <a class="page-link" href="index.do?catno=${category.no }&pageno=${page.pageNo -1 }">이전</a>
			       </li>
			       <c:forEach var="num" begin="${page.beginPage }" end="${page.endPage }">
			       		<li class="page-item ${num eq page.pageNo ? 'active' : '' }">
			       			<a class="page-link" href="index.do?catno=${category.no }&pageno=${num}">${num }</a>
			       		</li>
			       </c:forEach>
				       <li class="page-item ${page.pageNo lt page.totalPages ? '' : 'disabled' }">
				       		<a class="page-link" href="index.do?catno=${category.no }&pageno=${page.pageNo + 1}">다음</a>
				       </li>
		       </ul>
	       </div>
       </div>
