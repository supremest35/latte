	         ...
	         <div class="card-body">
	            ...
	            <div class="form-row">
	               <div class="form-group col-12">
	                  ...
	                  <input type="number" class="form-control" name="price" id="acorn-price" min="0" value="0"/>
	               </div>
	            </div>
	            <div class="form-row">
	               <div class="form-group col-12">
	                  <label>수량</label>
	                  <input type="number" class="form-control" name="stock" id="acorn-price" min="0" value="0"/>
	               </div>
	            </div>
	            <div class="form-row">
